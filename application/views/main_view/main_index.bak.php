        ...
        <div class="my-bg-image">
            <div class="my-3">
				...
				<div class="alert alert-danger">
					<marquee width="100%" direction="up" height="100px" scrollamount="2" onmouseover="this.stop();" onmouseout="this.start();">
						<div>							
							<span class="h3"><span><img src="<?= base_url('assets/images/AlertIcon.gif') ?>" width="25" /></span> เนื่องจากมีการแพร่ระบาดของเชื้อโรค COVID-19 จึงเลื่อนการทดสอบภาษาอังกฤษไปจนกว่าสถานการณ์จะคลี่คลายลง</span>
						</div>
					</marquee>
				</div>
